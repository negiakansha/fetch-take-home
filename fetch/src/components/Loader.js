//Open source Loader from codepen
//Read license in README for more information
...
const Loader = () => {
  return (
    <>
        ...
        <div className="rainbow-memorial-loader-wrapper" id="rainbowMemorialLoader">
            <div className="rainbow-memorial-loader">
                <div className="paw"><svg className="icon"><use href="#paw" /></svg></div>
                <div className="paw"><svg className="icon"><use href="#paw" /></svg></div>
                <div className="paw"><svg className="icon"><use href="#paw" /></svg></div>
                <div className="paw"><svg className="icon"><use href="#paw" /></svg></div>
                <div className="paw"><svg className="icon"><use href="#paw" /></svg></div>
